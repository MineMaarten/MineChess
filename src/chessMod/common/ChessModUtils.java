...
public class ChessModUtils{
    ...
    public static void spawnParticle(String particleName, double x, double y, double z, double velX, double velY, double velZ){
        PacketDispatcher.sendPacketToAllPlayers(PacketHandlerChessMod.spawnParticle(particleName, x, y, z, velX, velY, velZ));
    }
    ...
    public static void sendUnlocalizedMessage(EntityPlayer player, String message, String... replacements){
        PacketDispatcher.sendPacketToPlayer(PacketHandlerChessMod.getChatMessagePacket(message, replacements), (Player)player);
    }
