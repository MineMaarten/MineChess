...
public class AchievementHandler{
    ...
    public static void init(){
        achieveList.add(new Achievement(MOVE_PIECE_ID, "movePiece", 1, 3, new ItemStack(ChessMod.itemPieceMover, 1, 0), null).setIndependent());
        achieveList.add(new Achievement(CASTLING_ID, "castling", 1, -1, new ItemStack(ChessMod.itemPieceMover, 1, 0), getAchieveFromID(MOVE_PIECE_ID)).setIndependent().setSpecial());
        achieveList.add(new Achievement(ENTER_ARENA_ID, "enterArena", 3, 5, new ItemStack(ChessMod.itemPieceMover, 0, 4), null).setIndependent());
        ...
        achieveList.add(new Achievement(EN_PASSANT_ID, "enPassant", 1, 7, new ItemStack(ChessMod.itemPieceMover, 1, 0), getAchieveFromID(MOVE_PIECE_ID)).setIndependent().setSpecial());
        ...
        achieveList.add(new Achievement(STALEMATE_ID, "stalemate", -1, 1, new ItemStack(ChessMod.itemPieceMover, 1, 0), getAchieveFromID(MOVE_PIECE_ID)).setIndependent().setSpecial());
        achieveList.add(new Achievement(CHECKMATE_ID, "checkmate", -1, 3, new ItemStack(ChessMod.itemPieceMover, 1, 0), getAchieveFromID(MOVE_PIECE_ID)).setIndependent());
        achieveList.add(new Achievement(CHECK_ID, "check", -2, 4, new ItemStack(ChessMod.itemPieceMover, 1, 0), getAchieveFromID(MOVE_PIECE_ID)).setIndependent());
        achieveList.add(new Achievement(LOSE_ID, "lose", -1, 5, new ItemStack(ChessMod.itemPieceMover, 1, 0), getAchieveFromID(MOVE_PIECE_ID)).setIndependent());
    ...
    public static void giveAchievement(EntityPlayer player, int achieve){
        if(player.worldObj.isRemote) {
            ...
            PacketDispatcher.sendPacketToPlayer(PacketHandlerChessMod.getAchievementPacket(achieve), (Player)player);
        }
    }
